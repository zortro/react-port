    ...
    return (
        <div>
            <div className='bannerCont'>
                <img className='banner' src='https://www.freeiconspng.com/thumbs/person-icon/clipart--person-icon--cliparts-15.png' alt='banner'/>
                <img className='bannerBg' src='https://toppng.com/public/uploads/thumbnail/color-splash-png-11552178266e4ytahhcqq.png' alt='banner'/>
            </div>
            <div className='aboutCont'>
                <section className="about">
                    <aside>
                        ...
                        <p>Benjamin can write in HTML, CSS, JavaScript, MySQL, NoSQL and is confident in react applications. Using these technologies Benjamin can fit all of your needs from front end to back end development. Benjamin attended a coding bootcamp at the University of Washington in December of 2021 and graduated in March of 2022 and has since been ready to use his coding skills to meet the needs of employers.</p>
